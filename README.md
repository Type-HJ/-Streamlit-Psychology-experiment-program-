# 심리학 실험 프로그램 - Streamlit 버전

Streamlit을 사용한 심리학 실험 프로그램입니다. 스트룹 과제와 클릭 반응 테스트를 수행할 수 있으며, 실시간 데이터 분석과 시각화를 제공합니다.
...
**웹 버전은 [Psychology-experiment-program](https://github.com/Type-HJ/Psychology-experiment-program) 저장소를 참고하세요.**